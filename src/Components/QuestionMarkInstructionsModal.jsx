   ...
   <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <div style={{ display: 'grid', gap: '1rem', marginBottom: '1rem' }}>
         ...
         <Section title="Advanced Usage">
            <p>
               Pressing the <button style={{ padding: '0.15rem 1rem' }}><SquareFunction /></button> button reveals an additional keyboard with advanced functions.
            </p>
            <p>
            ...
            <SubSection title="Supported Units">
               <p>The calculator can convert and operate with various physical quantities. Here's a list of supported units:</p>
               <UnitTable />
            </SubSection>
            <SubSection title="Unit Conversion Examples">
               <ol style={{ padding: '0 0 0 2rem', lineHeight: '1.5' }}>
         ...
         <Section title="Complex Numbers">
            <p>For <span>algebraic form</span>, use the format <span>a + b*i</span>.</p>
            ...
            <p>In <span>polar form</span>, <span>degrees</span> are always used both for manual input and internal calculations.</p>
            <p>When you press the <button style={{ padding: '0.15rem 1rem' }}>To Polar</button> button, the complex value output will be in degrees, not radians.</p>
            <p><strong style={{ color: 'var(--primary-color)' }}>Note: This calculator can't handle physical units (like meters, seconds, etc.) when working with complex numbers.</strong></p>
         </Section>

         <Section title="Variables">
            <p>To create a variable, click the <button style={{ padding: '0.15rem 1rem' }}><HardDriveDownload /></button> button. A window will appear where you can <span>name your variable</span>. The <span>current value in the input field</span> will be assigned to this variable.</p>
            <p>You can <span>find all created variables</span> in the history section for later use. Access the history by clicking the <button style={{ padding: '0.15rem 1rem' }}>history</button> button, then select <button style={{ padding: '0.15rem 1rem' }}><HardDriveDownload /></button> to view your saved variables.</p>
            <p>Use variables in your calculations by simply typing their names in the input field.</p>
            <SubSection title="Variable Keyboard">
               <p>After creating variables, a new keyboard becomes available. To access it:</p>
               <ol>
                  <li>Click the <button style={{ padding: '0.15rem 1rem' }}><Box /></button> button to switch to the variable keyboard.</li>
                  <li>You'll see buttons for each variable you've created.</li>
                  <li>Click on a variable button to insert its name into the input field.</li>
                  <li>To switch back to the regular keyboard, click the <button style={{ padding: '0.15rem 1rem' }}><Calculator /></button> button.</li>
               </ol>
               <p>This feature allows quick access to your variables without needing to type them manually or access the history each time.</p>
            </SubSection>
         </Section>

         <Section title="Interacting with History">
            <p>When solving multi-step problems, you often need to use previously calculated values. To streamline this process, we've added the following buttons:</p>
            ...
            <p>Clicking any of these buttons will copy the selected information and automatically append it to the end of the main input field. This allows you to quickly use previous calculations or variables in new computations.</p>
            <p>To access your history, click the <button style={{ padding: '0.15rem 1rem' }}>history</button> button. In the history window, you can switch between calculation history and saved variables using the <button style={{ display: 'inline-flex', padding: '0.15rem 1rem' }}><HardDriveDownload /> / <Calculator /></button> toggle button.</p>
         </Section>

         <Section title="Additional Notes">
            <p><strong style={{ color: 'var(--primary-color)' }}>All additional windows, including history cards, can be closed by clicking anywhere outside of the cards.</strong></p>
         </Section>
      </div>
   </Modal>
);
